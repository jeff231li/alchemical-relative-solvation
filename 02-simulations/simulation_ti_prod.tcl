...
set outputname    production
set common_folder ../../build_files
set restart_file  equilibration                  ;# Only used if restart is set to 1
...
# MD steps
set ProdSteps     1000000            ;# (1000000 x 2.0fs) = 2 ns per window production
...
if {$restart == 0} {
  ...
  # Restart file(s)
  binCoordinates    $restart_file.restart.coor
  binVelocities     $restart_file.restart.vel   ;# remove the "temperature" entry if you use this!
  extendedSystem    $restart_file.restart.xsc
}
