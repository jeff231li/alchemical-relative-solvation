...
#############################################################
# NAMD3 GPU option
CUDASOAintegrate  off ;# Must be off during minimization

# Input/Ouput options
set inputname     Ac1-Ac2-solvated
set outputname    minimization
set common_folder ../../build_files
set restart_file  ${common_folder}/minimization ;# Only used if restart is set to 1
...
# restart, temp etc.
set restart       0                  ;# 0 - start from scratch, 1 - restart from previous files
...
# MD steps
set MinSteps      1000               ;# 1000 steps of energy minimization
